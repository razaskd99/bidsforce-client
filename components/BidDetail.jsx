                ...
                {stages.map((stageData, index) => (
                    <svg key={index} xmlns="http://www.w3.org/2000/svg" width="9%" viewBox="0 0 155 40" fill="none" onClick={() => contentShow(stageData.stage, stageData.status)} className={`${stageData.status === 'pending' ? 'cursor-not-allowed' : 'cursor-pointer'}`}>
                        <g filter={`url(#filter0_d_4480_${index})`}>
                            ...
                            <text x="50%" y="50%" textAnchor="middle" dy=".3em" fill={getStatusColor(stageData.status)} fontSize="16">{stageData.stage == 'Initiate' ? 'Initiated' : stageData.stage}</text>
                        </g>
                        <defs>
            ...
            <div className="Content bg-white">
                    ...
                    <div className="flex w-full gap-4">
                        ...
                        <div className="flex-[1] flex flex-col">
                            <div className="flex items-center gap-3 mt-[-16px]">
                                <span className="text-[#778CA2]">Last Updated: {formatDatetime(new Date())} </span>
                ...
                {active === 'Bid Setup' && <div className='p-5 bg-white shadow-sm h-full min-h-screen'>
                    <div className="max-w-[80%]">
                        ...
                        <ControlledAccordions tenantID={tenantID} rfxRecord={rfxRecord} allUsersRec={allUsersRec} koffRec={koffRec} deliverablesRec={deliverablesRec} login_user_id={login_user_id} bidteamRec={bidteamRec} active={active === 'Bid Setup' ? true : false} />
                    </div>
