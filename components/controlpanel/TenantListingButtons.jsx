...
export default function TenantListingButtons(props) {
  ...
  const handleChangeValues = (e) => {
    ...
    if (e.target.name === "tenant_status") {
      data = {
        ...data,
        tenant_is_active: e.target.value == "Active" ? true : false,
      };
    }
    setTenants({ ...data });
  };
                      ...
                      <div className="mt-0" key={0}>
                        ...
                        >
                          ...
                          <option
                            value="Beginer"
                            selected={
                              tenants.subscription_type == "Beginer"
                                ? true
                                : false
                            }
                          >
                          ...
                          <option
                            value="Premium"
                            selected={
                              tenants.subscription_type == "Premium"
                                ? true
                                : false
                            }
                          >
                          ...
                          <option
                            value="Professional"
                            selected={
                              tenants.subscription_type == "Professional"
                                ? true
                                : false
                            }
                          >
