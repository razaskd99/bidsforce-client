...
export default function CardDetailsPage(props) {
  ...
  const [values, setValues] = useState({ ...props.card, tags: [],  task: [] });
  ...
  const calculatePercent = () => {
    const totalTask = values.task ? values.task.length : 0;
    const completedTask = values.task ? values.task.filter(
