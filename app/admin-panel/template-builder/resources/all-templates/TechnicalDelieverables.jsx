...
`,
    ...
    <div class="mx-auto max-w-7xl px-4 mt-8">
        ...
        <div class="container mx-auto px-4 py-2 custome-color-card mt-1">
            <div class="flex flex-wrap -mx-2 justify-between">
                <div class="w-1/2 md:w-1/2 px-2">
                    <span class="text-base font-md text-black ">10 Summary</span>
                </div>
        ...
        <div class="container custome-color-card  mx-auto px-4 py-2  mt-1">
            <div class="flex flex-wrap -mx-2 justify-between">
                <div class="w-1/2 md:w-1/2 px-2">
                    <span class="text-base font-md text-black">Bill of Material</span>
                </div>
                <div class="w-1/2 md:w-1/2 px-2 flex justify-end">
                    <label class="relative inline-block w-12 h-6 cursor-pointer">
                        <!-- Checkbox -->
        ...
        <div class="container custome-color-card  mx-auto px-4 py-2  mt-1">
            <div class="flex flex-wrap -mx-2 justify-between">
                <div class="w-1/2 md:w-1/2 px-2">
                    <span class="text-base font-md text-black">MOU/Agreements Developments</span>
                </div>
                <div class="w-1/2 md:w-1/2 px-2 flex justify-end">
                    <label class="relative inline-block w-12 h-6 cursor-pointer">
                        <!-- Checkbox -->
        ...
        <div class="container custome-color-card  mx-auto px-4 py-2  mt-1">
            <div class="flex flex-wrap -mx-2 justify-between">
                <div class="w-1/2 md:w-1/2 px-2">
                    <span class="text-base font-md text-black">Power & Heat Load Calculation</span>
                </div>
                <div class="w-1/2 md:w-1/2 px-2 flex justify-end">
                    <label class="relative inline-block w-12 h-6 cursor-pointer">
                        <!-- Checkbox -->
        ...
        <div class="container custome-color-card  mx-auto px-4 py-2  mt-1">
            <div class="flex flex-wrap -mx-2 justify-between">
                <div class="w-1/2 md:w-1/2 px-2">
                    <span class="text-base font-md text-black">Project Executon Plan</span>
                </div>
                <div class="w-1/2 md:w-1/2 px-2 flex justify-end">
                    <label class="relative inline-block w-12 h-6 cursor-pointer">
                        <!-- Checkbox -->
        ...
        <div class="container custome-color-card  mx-auto px-4 py-2  mt-1">
            <div class="flex flex-wrap -mx-2 justify-between">
                <div class="w-1/2 md:w-1/2 px-2">
                    <span class="text-base font-md text-black">Project Schedule</span>
                </div>
                <div class="w-1/2 md:w-1/2 px-2 flex justify-end">
                    <label class="relative inline-block w-12 h-6 cursor-pointer">
                        <!-- Checkbox -->
        ...
        <div class="container custome-color-card  mx-auto px-4 py-2  mt-1">
            <div class="flex flex-wrap -mx-2 justify-between">
                <div class="w-1/2 md:w-1/2 px-2">
                    <span class="text-base font-md text-black">RASCI Matrix</span>
                </div>
                <div class="w-1/2 md:w-1/2 px-2 flex justify-end">
                    <label class="relative inline-block w-12 h-6 cursor-pointer">
                        <!-- Checkbox -->
        ...
        <div class="container custome-color-card  mx-auto px-4 py-2  mt-1">
            <div class="flex flex-wrap -mx-2 justify-between">
                <div class="w-1/2 md:w-1/2 px-2">
                    <span class="text-base font-md text-black">Table of Content</span>
                </div>
                <div class="w-1/2 md:w-1/2 px-2 flex justify-end">
                    <label class="relative inline-block w-12 h-6 cursor-pointer">
                        <!-- Checkbox -->
        ...
        <div class="container custome-color-card  mx-auto px-4 py-2  mt-1">
            <div class="flex flex-wrap -mx-2 justify-between">
                <div class="w-1/2 md:w-1/2 px-2">
                    <span class="text-base font-md text-black">Technical Compliance</span>
                </div>
                <div class="w-1/2 md:w-1/2 px-2 flex justify-end">
                    <label class="relative inline-block w-12 h-6 cursor-pointer">
                        <!-- Checkbox -->
