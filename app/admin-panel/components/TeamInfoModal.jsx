            ...
            <div className="modal-dialog modal-dialog-centered" role="document">
              <div className="modal-content" id="modalFormComponent1">
                <div className="modal-header">
                  <h4 className="modal-title" id="modalCenterTitle">New Team</h4>
                ...
                <div className="modal-body" id="modalFormComponentBody1">
                  <form id="modalform3">
                    <div className="row">
                      <div className="col mb-4 mt-2">
                        <div className="form-floating form-floating-outline">
                            <input type="text" onChange={handleChangeValues} id="m3_team_title" name="m3_team_title" value={formData.m3_team_title} className="form-control" placeholder="Enter Title" />
                    ...
                    <div className="row">
                      <div className="col mb-4 mt-2">
                        <div className="form-floating form-floating-outline">
                          <select onChange={handleChangeValues} id="m3_team_role" name="m3_team_role" className="form-select">
                    ...
                    <div className="row">
                      <div className="col mb-2 mt-2">
                        <div className="form-floating form-floating-outline">
                          <select onChange={handleChangeValues} id="m3_role_level" name="m3_role_level" className="form-select">
