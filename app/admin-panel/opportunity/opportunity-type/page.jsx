...
export default async function AdminPanelDesignation({searchParams}) {
  ...
  // get all opp type
  let response = await getAllOppPrereqRecordsAction("opportunity_type", searchTermValue, offset, limit);
  ...
  const breadcrumbItems = [
    ...
    { label: "Opportunity Type", href: "/admin-panel/opportunity/opportunity-type" },
  ];
  ...
  return (
    ...
    <div>
      <OppPrereqTable allRecords={allRecords} tableName={"opportunity_type"}/>
    </div>
