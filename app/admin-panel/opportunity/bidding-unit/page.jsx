...
export default async function AdminPanelDesignation({searchParams}) {
  ...
  let records = await getAllOppPrereqRecordsAction("bidding_unit", searchTermValue, offset, limit);
  ...
  const breadcrumbItems = [
    ...
    { label: "Bidding Unit", href: "/admin-panel/opportunity/bidding-unit" },
  ];
  ...
  return (
    <div className=" w-full">
      ...
      <div>
        <OppPrereqTable allRecords={allRecords} tableName={"bidding_unit"}/>
      </div>
