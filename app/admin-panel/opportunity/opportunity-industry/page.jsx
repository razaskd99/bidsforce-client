...
export default async function AdminPanelOppIndustry({searchParams}) {
  // search terms
  ...
  let records = await getAllOppPrereqRecordsAction("opportunity_industry", searchTermValue, offset, limit);
  ...
  const breadcrumbItems = [
    ...
    { label: "Sales Pursuit Progress", href: "/admin-panel/opportunity/sales-pursuit-progress" },
  ];
  ...
  return (
    ...
    <div className="">
      ...
      <div className="flex items-center gap-2">
        <OppPrereqAddNewButton 
          buttonName={"opportunity_industry"} 
          buttonType={"new"} 
        />
    ...
    <div>
      <OppPrereqTable allRecords={allRecords} tableName={"opportunity_industry"}/>
    </div>
