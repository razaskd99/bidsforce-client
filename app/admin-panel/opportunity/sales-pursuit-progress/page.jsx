...
export default async function AdminPanelDesignation({searchParams}) {
  ...
  let records = await getAllOppPrereqRecordsAction("sales_pursuit_progress", searchTermValue, offset, limit);
  ...
  return (
    ...
    <div className="">
      ...
      <div className="flex items-center gap-2">
        <OppPrereqAddNewButton 
          buttonName={"sales_pursuit_progress"} 
          buttonType={"new"} 
        />
    ...
    <div>
      <OppPrereqTable allRecords={allRecords} tableName={"sales_pursuit_progress"}/>
    </div>
