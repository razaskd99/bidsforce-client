...
export default async function AdminPanelDesignation({searchParams}) {
  ...
  let records = await getAllRfxPrereqRecordsAction("bid_validity", searchTermValue, offset, limit);
  ...
  return (
    <div className=" w-full">
      ...
      <div>
        <RfxPrereqTable allRecords={allRecords} tableName={"bid_validity"}/>
      </div>
