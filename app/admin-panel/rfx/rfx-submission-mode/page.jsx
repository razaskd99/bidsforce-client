...
export default async function AdminPanelDesignation({searchParams}) {
  ...
  let records = await getAllRfxPrereqRecordsAction("rfx_submission_mode", searchTermValue, offset, limit);
  ...
  return (
    <div className=" w-full">
      ...
      <div>
        <RfxPrereqTable allRecords={allRecords} tableName={"rfx_submission_mode"}/>
      </div>
