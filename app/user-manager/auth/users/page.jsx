      ...
      <div className=" w-full">  
        ...
        <div className="grid grid-cols-1 gap-10 flex-[2]"> 
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div className="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-[#F2F4F6] dark:bg-gray-900">
                    <div>                        
                      ...
                      {userData.map((item, index) => (                            
                        ...
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" key={index}>
                            ...
                            <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                <div className="">
                                    <div className="text-base font-semibold"><Link href={'/dashboard/auth/register'}>{item.first_name + ' ' + item.last_name}</Link></div>
